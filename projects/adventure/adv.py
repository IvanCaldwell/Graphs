...
# Fill this out
traversalPath = []          #Ohhhhhhh somebody isn't following PEP 8
traversalGraph = {}
...
#        print("Queue Length:", queue.size())
        ...
        #print("Queue Length:", len(queue))
#        print("Queue Length:", queue.size())
        # gets the last room from our path
        current_room = path[-1]
#        print(current_room)
        ...
        if current_room not in visited_rooms:
            # when we hit an unvisited room add them to the visited set
            visited_rooms.add(current_room)

            # check if current room has any unexplored exits
            for exit in traversalGraph[current_room]:
                if traversalGraph[current_room][exit] == '?':
                    return path

            # enqueue the paths to to each of its exits
            for exit in traversalGraph[current_room]:
                traversal_paths.append(exit)
...
while len(traversalGraph) < len(roomGraph):
    ...
    # at a deadend do a bfs and backtrack
